...
public class GeneratePublicResourceHandler extends AbstractAndroidHandler {
    ...
    public boolean handle() {
        ...
        // 2.read the resource item properties,include resource entry cache and
        // resource file cache
        // 3.find the modify file(drawable,layout) and change to new file,keep
        // all the modify resource key
        // 4.find the modify string,color,dimen and copy to a new string color
        // dimen.
        // 5.find the increase file(drawable,layout) and copy that
        // 6.iterate the modify resource key and modify all the reference
        // resource file
        ...
        // Map<RType,Map<String,Set<ResourceEntry>>>
        // modifiedResourceEntryMap=new
        // HashMap<RType,Map<String,Set<ResourceEntry>>>();
        // this.generateIncreaseAndModifiedResource(originalResourceDirectoryList,
        // rTypeResourceDirectoryMap, baseResourceItemMappingProperties,
        // resourceItemMappingProperties, resourceItemMappingFullFilename,
        // !rTypeResourceMap.isEmpty());
        ...
        for (AndroidProject androidProject : androidProjectList) {
            ...
            if (resourceDirectoryList == null || resourceDirectoryList.isEmpty()) {
                continue;
            }

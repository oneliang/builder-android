...
public abstract class AndroidConfiguration extends JavaConfiguration {
    ...
    protected int autoDexFieldLimit = 0xFFD0;// dex field must less than
                                             // 65536,but field stat always less
                                             // then in
    ...
    // protected final Map<String, AndroidProject> androidProjectMap=new
    // ConcurrentHashMap<String, AndroidProject>();
    ...
    protected void initializeAllProject() {
        ...
        // add project to android project list,reset project list and project
        // map
        ...
        // all android project,find parent android project list of android
        // project and find all package name
     ...
     *            the androidBuildToolsVersion to set
     */
    ...
    /**
     * @param projectMainProperties
     *            the projectMainProperties to set
     */
    ...
    /**
     * @param projectLoadModeAttachBaseContextMultiDex
     *            the projectLoadModeAttachBaseContextMultiDex to set
     */
    ...
    /**
     * @param buildOutputEclipse
     *            the buildOutputEclipse to set
     */
    ...
    /**
     * @param autoDexLinearAllocLimit
     *            the autoDexLinearAllocLimit to set
     */
    ...
    /**
     * @param autoDexFieldLimit
     *            the autoDexFieldLimit to set
     */
    ...
    /**
     * @param autoDexMethodLimit
     *            the autoDexMethodLimit to set
     */
    ...
    /**
     * @param autoDexMainDexOtherClasses
     *            the autoDexMainDexOtherClasses to set
     */
    ...
    /**
     * @param aaptGenerateRFile
     *            the aaptGenerateRFile to set
     */
    ...
    /**
     * @param apkPatchInputAllClassesJar
     *            the apkPatchInputAllClassesJar to set
     */
    ...
    /**
     * @param androidProjectDexTaskNodeInsertName
     *            the androidProjectDexTaskNodeInsertName to set
     */
    ...
    /**
     * @param multiAndroidProjectDexTaskNodeInsertName
     *            the multiAndroidProjectDexTaskNodeInsertName to set
     */
    ...
    /**
     * @param apkPatchInputRTxt
     *            the apkPatchInputRTxt to set
     */
    ...
    /**
     * @param apkPatchBaseApk
     *            the apkPatchBaseApk to set
     */
    ...
    /**
     * @param apkPatchResourceItemMapping
     *            the apkPatchResourceItemMapping to set
     */

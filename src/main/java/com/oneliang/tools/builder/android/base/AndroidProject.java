...
public class AndroidProject extends JavaProject {
    ...
    public void initialize() {
        ...
        // FileUtil.MatchOption matchOption=new
        // FileUtil.MatchOption(libsDirectory);
    ...
    public void parsePackageName() {
        if (!this.androidManifestList.isEmpty()) {
            ...
            this.packageName = parsePackageName(androidManifest);
        }
    }
    ...
    public static String parsePackageName(String androidManifestFullFilename) {
        ...
        if (FileUtil.isExist(androidManifestFullFilename)) {
            ...
            try {
                ...
                throw new BuildException(androidManifestFullFilename, e);
            }
        }
        return packageName;
    }
    ...
    /**
     * @param compilePlatforms
     *            the compilePlatforms to set
     */
    ...
    /**
     * @param thisTimeClassFileList
     *            the thisTimeClassFileList to set
     */
